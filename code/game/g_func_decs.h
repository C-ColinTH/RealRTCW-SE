...
extern char * Com_SkipTokens ( char * s , int numTokens , char * sep ) ;
extern char * Com_SkipCharset ( char * s , char * sep ) ;
...
extern void Com_TruncateLongString ( char * buffer , const char * s ) ;
extern char * QDECL va ( char * format , ... ) ;
extern int Q_strcasecmp ( char * s1 , char * s2 ) ;
extern int Q_strncasecmp ( char * s1 , char * s2 , int n ) ;
extern int QDECL Com_sprintf ( char * dest , int size , const char * fmt , ... ) ;
extern int Q_CountChar ( const char * string , char tocount ) ;
extern char * Q_CleanStr ( char * string ) ;
extern int Q_PrintStrlen ( const char * string ) ;
extern const char * Q_stristr ( const char * s , const char * find ) ;
extern void Q_strcat ( char * dest , int size , const char * src ) ;
extern int Q_strnicmp ( const char * string1 , const char * string2 , int n ) ;
...
extern int Com_HexStrToInt ( const char * str ) ;
...
extern qboolean COM_Eval ( char * cvarname , char * condition , char * cvarvalue ) ;
extern int COM_Compress ( char * data_p ) ;
extern char * SkipWhitespace2 ( char * data ) ;
...
extern void CopyLongSwap ( void * dest , void * src ) ;
extern void CopyShortSwap ( void * dest , void * src ) ;
...
extern qboolean COM_CompareExtension ( const char * in , const char * ext ) ;
extern void COM_StripExtension ( const char * in , char * out , int destsize ) ;
extern const char * COM_GetExtension ( const char * name ) ;
...
extern qboolean BoundsIntersectPoint ( const vec3_t mins , const vec3_t maxs , const vec3_t origin ) ;
extern qboolean BoundsIntersectSphere ( const vec3_t mins , const vec3_t maxs , const vec3_t origin , vec_t radius ) ;
extern qboolean BoundsIntersect ( const vec3_t mins , const vec3_t maxs , const vec3_t mins2 , const vec3_t maxs2 ) ;
...
extern void ThrowKnife( gentity_t	*ent ) ;
...
extern const char * BuildShaderStateConfig ( void ) ;
...
extern void SP_props_grammofon(gentity_t* ent);
extern void Use_props_grammofon(gentity_t* ent, gentity_t* self, gentity_t* activator);
extern void props_grammofon_death(gentity_t* ent, gentity_t* inflictor, gentity_t* attacker, int damage, int mod);
extern void props_grammofon_animate(gentity_t* ent);
...
extern gentity_t * SelectCTFSpawnPoint ( team_t team , int teamstate , vec3_t origin , vec3_t angles , qboolean isbot ) ;
...
extern void flakPuff ( vec3_t origin , qboolean sky , vec3_t forward ) ;
...
extern void AddTournamentQueue ( gclient_t * client ) ;
...
extern qboolean G_RadiusDamage2( vec3_t origin, gentity_t *inflictor, gentity_t *attacker, float damage, float radius, gentity_t *ignore, int mod, RadiusScope scope );
...
extern void player_die_secondchance( gentity_t *self, gentity_t *inflictor, gentity_t *attacker, int damage, int mod );
...
extern gentity_t * SelectNearestDeathmatchSpawnPoint_AI ( gentity_t *player ) ;
...
extern qboolean PM_AltFire ( void ) ;
extern qboolean PM_AltFiring ( qboolean delayedFire ) ;
...
extern void BG_ClipVelocity( vec3_t in, vec3_t normal, vec3_t out, float overbounce );
...
extern qboolean AICast_ScriptAction_ScreenFade ( cast_state_t * cs , char * params ) ;
...
extern qboolean AICast_ScriptAction_decoy ( cast_state_t * cs , char * params ) ;
...
extern qboolean AICast_ScriptAction_Achievement_chapter1_hard ( cast_state_t * cs , char * params ) ;
extern qboolean AICast_ScriptAction_Achievement_chapter2_hard ( cast_state_t * cs , char * params ) ;
extern qboolean AICast_ScriptAction_Achievement_chapter3_hard ( cast_state_t * cs , char * params ) ;
extern qboolean AICast_ScriptAction_Achievement_chapter4_hard ( cast_state_t * cs , char * params ) ;
extern qboolean AICast_ScriptAction_Achievement_chapter5_hard ( cast_state_t * cs , char * params ) ;
extern qboolean AICast_ScriptAction_Achievement_chapter6_hard ( cast_state_t * cs , char * params ) ;
...
extern qboolean AICast_ScriptAction_Achievement_pro51 ( cast_state_t * cs , char * params ) ;
extern qboolean AICast_ScriptAction_Achievement_sf ( cast_state_t * cs , char * params ) ;
extern qboolean AICast_ScriptAction_Achievement_ra ( cast_state_t * cs , char * params ) ;
extern qboolean AICast_ScriptAction_Achievement_ic ( cast_state_t * cs , char * params ) ;
extern qboolean AICast_ScriptAction_Achievement_capuzzo ( cast_state_t * cs , char * params ) ;
extern qboolean AICast_ScriptAction_Achievement_saucers ( cast_state_t * cs , char * params ) ;
extern qboolean AICast_ScriptAction_Achievement_arkot ( cast_state_t * cs , char * params ) ;
extern qboolean AICast_ScriptAction_Achievement_darkm ( cast_state_t * cs , char * params ) ;
extern qboolean AICast_ScriptAction_Achievement_darkm_2 ( cast_state_t * cs , char * params ) ;
extern qboolean AICast_ScriptAction_Achievement_dm2 ( cast_state_t * cs , char * params ) ;
extern qboolean AICast_ScriptAction_Achievement_dm2_2 ( cast_state_t * cs , char * params ) ;
extern qboolean AICast_ScriptAction_Achievement_dm2_3 ( cast_state_t * cs , char * params ) ;
extern qboolean AICast_ScriptAction_Achievement_dm2_4 ( cast_state_t * cs , char * params ) ;
extern qboolean AICast_ScriptAction_Achievement_tda_day ( cast_state_t * cs , char * params ) ;
extern qboolean AICast_ScriptAction_Achievement_tda_night ( cast_state_t * cs , char * params ) ;
extern qboolean AICast_ScriptAction_Achievement_tda_dark ( cast_state_t * cs , char * params ) ;
extern qboolean AICast_ScriptAction_Achievement_tda_plus ( cast_state_t * cs , char * params ) ;
extern qboolean AICast_ScriptAction_Achievement_tda_arena ( cast_state_t * cs , char * params ) ;
extern qboolean AICast_ScriptAction_Achievement_lion ( cast_state_t * cs , char * params ) ;
...
extern qboolean  AICast_ScriptAction_Achievement_VENDETTA1_3 ( cast_state_t * cs , char * params ) ;
extern qboolean  AICast_ScriptAction_Achievement_VENDETTA1_4 ( cast_state_t * cs , char * params ) ;
extern qboolean  AICast_ScriptAction_Achievement_VENDETTA1_5 ( cast_state_t * cs , char * params ) ;
extern qboolean  AICast_ScriptAction_Achievement_VENDETTA1_6 ( cast_state_t * cs , char * params ) ;
extern qboolean  AICast_ScriptAction_Achievement_VENDETTA1_7 ( cast_state_t * cs , char * params ) ;
extern qboolean  AICast_ScriptAction_Achievement_VENDETTA1_8 ( cast_state_t * cs , char * params ) ;
extern qboolean  AICast_ScriptAction_Achievement_VENDETTA1_9 ( cast_state_t * cs , char * params ) ;
extern qboolean  AICast_ScriptAction_Achievement_VENDETTA1_10 ( cast_state_t * cs , char * params ) ;
extern qboolean  AICast_ScriptAction_Achievement_VENDETTA1_11 ( cast_state_t * cs , char * params ) ;
extern qboolean  AICast_ScriptAction_Achievement_VENDETTA2_1 ( cast_state_t * cs , char * params ) ;
extern qboolean  AICast_ScriptAction_Achievement_VENDETTA2_2 ( cast_state_t * cs , char * params ) ;
extern qboolean  AICast_ScriptAction_Achievement_VENDETTA2_3 ( cast_state_t * cs , char * params ) ;
extern qboolean  AICast_ScriptAction_Achievement_VENDETTA2_4 ( cast_state_t * cs , char * params ) ;
extern qboolean  AICast_ScriptAction_Achievement_VENDETTA2_5 ( cast_state_t * cs , char * params ) ;
extern qboolean  AICast_ScriptAction_Achievement_VENDETTA2_6 ( cast_state_t * cs , char * params ) ;
extern qboolean  AICast_ScriptAction_Achievement_VENDETTA2_7 ( cast_state_t * cs , char * params ) ;
extern qboolean  AICast_ScriptAction_Achievement_VENDETTA2_8 ( cast_state_t * cs , char * params ) ;
extern qboolean  AICast_ScriptAction_Achievement_VENDETTA2_9 ( cast_state_t * cs , char * params ) ;
// Warbell achievements
extern qboolean AICast_ScriptAction_Achievement_WARBELL1( cast_state_t *cs, char *params );
extern qboolean AICast_ScriptAction_Achievement_WARBELL2( cast_state_t *cs, char *params );
...
extern qboolean AICast_ScriptAction_FaceEntity ( cast_state_t * cs , char * params ) ;
...
extern qboolean AICast_ScriptAction_SaveCheckpoint ( cast_state_t * cs , char * params ) ;
...
extern qboolean AICast_ScriptAction_GivePerk ( cast_state_t *cs, char *params );
extern qboolean AICast_ScriptAction_TakeWeapon ( cast_state_t * cs , char * params ) ;
extern qboolean AICast_ScriptAction_NoRespawn ( cast_state_t * cs , char * params ) ;
...
extern qboolean AICast_ScriptAction_SetWave ( cast_state_t * cs , char * params ) ;
...
extern char * AIFunc_xshepherdbiteStart ( cast_state_t * cs ) ;
extern char * AIFunc_xshepherdbite ( cast_state_t * cs ) ;
...
extern void AICast_SetRebirthTimeSurvival(gentity_t *ent, cast_state_t *cs);
extern void AICast_RegisterSurvivalKill(gentity_t *self, gentity_t *attacker, int meansOfDeath) ;
...
extern char *AIFunc_DogAttackStart ( cast_state_t * cs ) ;
extern char *AIFunc_DogBarkStart ( cast_state_t * cs ) ;
extern char *AIFunc_DogBark ( cast_state_t * cs ) ;
extern char *AIFunc_DogAttack ( cast_state_t * cs ) ;
